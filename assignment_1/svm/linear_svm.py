...
def svm_loss_vectorized(W, X, y, reg):
    ...
    # TODO: Implement a vectorized version of the gradient for the structured SVM loss,
    #  storing the result in dW #                                                                         #
    # Hint: Instead of computing the gradient from scratch, it may be easier to reuse some
    # of the intermediate values that you used to compute the loss.
    #
    #############################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    binary = margin
