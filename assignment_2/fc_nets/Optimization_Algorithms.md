...
![image_description](sgd_vs_momentum.png)
...
![image_description](different_models.png)

Different Models comparison: {'sgd': 1e-3, 'sgd_momentum':  1e-3, 'rmsprop': 1e-3, 'adam': 1e-3}

![image_description](different_models_same_lr.png)
...
#### 'sgd' : [1e-4, 5e-3, 3e-3, 1e-3, 1e-2]
![image_description](sgd_lr.png)

#### 'sgd_momentum': [1e-4, 5e-3, 3e-3, 1e-3, 1e-2]
![image_description](sgd_moment_lr.png)

#### 'rmsprop': [1e-4, 5e-4, 5e-3, 1e-3, 1e-2]
![image_description](rms_lr.png)
...
![image_description](rms_lr_smaller.png)

####'adam': [1e-4, 5e-4, 5e-3, 1e-3, 1e-2]
![image_description](adam_lr.png)
